...
def replace_parameter(arg, text, new_arg, new_parameter):
    return text.replace(arg + " " + get_parameters(arg, text), new_arg + " " + new_parameter)
    

def remove_parameter(arg, text):
    return text.replace(arg + " " + get_parameters(arg, text), "")
